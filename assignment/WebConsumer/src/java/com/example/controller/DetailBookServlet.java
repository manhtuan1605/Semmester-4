...
//        processRequest(request, response);
        ...
        List<Books> listBook = findByCode(bookcode);
        request.setAttribute("listBook", listBook);
                RequestDispatcher rd = request.getRequestDispatcher("DetailBook.jsp");
                if (rd != null) {
    ...
    private java.util.List<myservices.Books> findByCode(java.lang.String arg0) {
        ...
        myservices.ListBookService port = service.getListBookServicePort();
        return port.findByCode(arg0);
    }

    private java.util.List<myservices.Books> findByCode_1(java.lang.String arg0) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        myservices.ListBookService port = service.getListBookServicePort();
        return port.findByCode(arg0);
